...
*/
let me = { name: "Alessio", surname: "Cardinali", age: 26 };
/* ESERCIZIO D
...
function deleteOne(stringa, boolean) {
  let sliced2 = stringa.slice(0, -1);
  let sliced1 = stringa.slice(0, 1);
  if (boolean === true) {
    return sliced1;
  } else {
    return sliced2;
...
function howManyDays(data) {
  ...
  let differenzamesi = oggi - dataFornita;
  let differenzaGiorni = Math.floor(differenzamesi / (1000 * 60 * 60 * 24));
  return differenzaGiorni;
}

let giorniTrascorsi = howManyDays("2023-01-01");
